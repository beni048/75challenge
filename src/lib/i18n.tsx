...
const en = {
  ...
  'onboarding.committingTitle': 'Setting up your challenge',
  'onboarding.committingBody': 'One moment — taking you to Day 1.',
  ...
  'story.noShield': 'No Shield',
  'story.day': 'DAY {day}',
  'story.ofDays': 'of 75 days',
  'story.habitsHeading': 'The habits I am practising:',
  'story.habitsHeadingFuture': 'I will train these habits...',
  'story.committedToStart': 'Committed to start on {date}',
  'story.export': 'Save card to share',
  'story.exporting': 'Making your card...',

  'storyPicker.title': 'Choose your habits',
  'storyPicker.intro': 'Pick {max} to show on your card.',
  'storyPicker.confirm': 'Use {count}/{max} selected',
  'storyPicker.change': 'Change habits',
  ...
  'day.futureBody': 'You can log {date} once it gets here — take a look below at what is scheduled.',
  'day.futureRestBody': 'Nothing is scheduled on {date} — enjoy the day off.',
  'day.scheduledLabel': 'Scheduled for this day',
...
const de: Record<TranslationKey, string> = {
  ...
  'onboarding.committingTitle': 'Deine Challenge wird eingerichtet',
  'onboarding.committingBody': 'Einen Moment – es geht gleich zu Tag 1.',
  ...
  'story.noShield': 'Kein Schild',
  'story.day': 'TAG {day}',
  'story.ofDays': 'von 75 Tagen',
  'story.habitsHeading': 'Diese Routinen trainiere ich:',
  'story.habitsHeadingFuture': 'Ich werde diese Routinen trainieren...',
  'story.committedToStart': 'Ich starte am {date}.',
  'story.export': 'Karte sichern',
  'story.exporting': 'Deine Karte entsteht ...',

  'storyPicker.title': 'Wähl deine Routinen',
  'storyPicker.intro': 'Wähl {max} für deine Karte aus.',
  'storyPicker.confirm': '{count}/{max} ausgewählt verwenden',
  'storyPicker.change': 'Routinen ändern',
  ...
  'day.futureBody': 'Den {date} kannst du eintragen, sobald er da ist – unten siehst du, was ansteht.',
  'day.futureRestBody': 'Am {date} steht nichts an – geniess den freien Tag.',
  'day.scheduledLabel': 'Für diesen Tag geplant',
